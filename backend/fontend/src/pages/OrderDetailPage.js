...
function OrderDetailPage() {
  ...
  function formatPhoneNumber(phone) {
    ...
    // 010-XXXX-XXXX 또는 011-XXX-XXXX 등 처리
    ...
    return phone; // 포맷 안 맞으면 그대로 반환
  }

  return (
    <div className="container" style={{ paddingTop: 150, paddingBottom:100 }}>
      <h2 style={{ textAlign: "center", fontWeight: "bold", marginBottom: 50 }}>주문 상세 내역</h2>
      ...
      <div style={{display:'flex', justifyContent: "space-between"}}>
        <div className="">
          <button
            ...
            onClick={() => navigate(-1)} // 또는 navigate("/orders")
          >
            ← 목록으로
          </button>
        </div>
